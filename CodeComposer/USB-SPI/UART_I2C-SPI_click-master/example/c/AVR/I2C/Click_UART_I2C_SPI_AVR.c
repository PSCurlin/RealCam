...
void systemInit()
{
    ...
    mikrobus_i2cInit( _MIKROBUS1, &_UARTI2CSPI_I2C_CFG[0] );
    Delay_ms( 100 );
}

void applicationInit()
{
    uarti2cspi_i2cDriverInit( (T_UARTI2CSPI_P)&_MIKROBUS1_GPIO, (T_UARTI2CSPI_P)&_MIKROBUS1_I2C, UARTI2CSPI_ADDR );
